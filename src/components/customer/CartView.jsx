...
Please confirm receipt and guide me on payment details!`;
  ...
  if (orderPlaced) {
    return (
      <div style={{ maxWidth: '600px', margin: '6rem auto', padding: '3rem 2rem', textAlign: 'center', background: 'rgba(255, 255, 255, 0.03)', border: '1px solid rgba(255, 255, 255, 0.12)', backdropFilter: 'blur(10px)', color: 'white', borderRadius: '12px', boxShadow: '0 20px 50px rgba(0,0,0,0.3)' }} className="animate-fade-in">
        <div style={{ width: '64px', height: '64px', borderRadius: '50%', background: 'rgba(194, 139, 83, 0.2)', display: 'flex', alignItems: 'center', justify: 'center', margin: '0 auto 1.5rem auto' }}>
          <ShieldCheck size={36} style={{ color: 'var(--color-gold-light)' }} />
        </div>
        <h2 style={{ fontSize: '1.8rem', color: '#ffffff', marginBottom: '0.8rem' }}>Order Placed Successfully!</h2>
        <p style={{ fontSize: '0.95rem', color: 'rgba(255, 255, 255, 0.85)', marginBottom: '1.5rem', lineHeight: '1.6' }}>
        ...
        <div style={{ padding: '1rem', background: 'rgba(255, 255, 255, 0.05)', border: '1px solid rgba(255,255,255,0.08)', borderRadius: '6px', textAlign: 'left', marginBottom: '2rem', fontSize: '0.85rem', color: 'rgba(255,255,255,0.9)' }}>
    ...
    <div style={{ background: 'transparent', padding: '3rem 0' }}>
      <div className="cart-layout">
        ...
        <div className="cart-items-panel">
          <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'baseline', borderBottom: '1px solid var(--color-border-gold)', paddingBottom: '0.8rem' }}>
            <h2 style={{ fontSize: '1.6rem' }}>Your Shopping Bag</h2>
            <button 
          ...
          {cart.length > 0 ? (
                ...
                <div key={`${item.id}_${item.selectedColor}`} className="cart-item-row animate-fade-in">
                  ...
                  <div className="cart-item-info">
                    ...
                    <div className="cart-item-qty">
                      ...
                      <span style={{ fontSize: '0.85rem', fontWeight: 600, padding: '0 0.4rem' }}>{item.quantity}</span>
                      <button 
                        className="qty-btn"
                        onClick={() => onUpdateQty(item.id, item.selectedColor, item.quantity + 1)}
                      >
                  ...
                  <div style={{ textAlign: 'right' }}>
                    <span style={{ fontWeight: 600, color: 'var(--color-brown-primary)', display: 'block', fontSize: '0.95rem' }}>
            ...
            <div style={{ padding: '6rem 2rem', textAlign: 'center', background: 'rgba(255, 255, 255, 0.03)', borderRadius: '8px', border: '1px solid rgba(255, 255, 255, 0.12)', backdropFilter: 'blur(10px)' }}>
              <ShoppingBag size={48} style={{ color: 'rgba(255, 255, 255, 0.4)', marginBottom: '1rem' }} />
              <h3 style={{ fontSize: '1.2rem', color: '#ffffff', marginBottom: '0.5rem' }}>Your Bag is Empty</h3>
        ...
        <div className="cart-checkout-panel">
          <h3 style={{ fontSize: '1.2rem', borderBottom: '1px solid var(--color-border-gold)', paddingBottom: '0.8rem', marginBottom: '1.5rem' }}>Order Checkout</h3>
