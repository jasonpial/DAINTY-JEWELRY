...
function App() {
  ...
  return (
    <div className="app-container">
      ...
      {!isAdminView && (
        <footer className="site-footer" style={{ color: '#a8a29e', paddingTop: '4rem' }}>
          <div style={{ maxWidth: '1200px', margin: '0 auto', padding: '0 2rem 3rem 2rem', display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(220px, 1fr))', gap: '3rem' }}>
            ...
            <div>
              ...
              <p style={{ fontSize: '0.85rem', lineHeight: '1.7', color: '#78716c' }}>
            ...
            <div>
              ...
              <ul style={{ listStyle: 'none', display: 'flex', flexDirection: 'column', gap: '0.6rem', fontSize: '0.85rem' }}>
                <li><a href="#/shop?collection=new_arrivals" style={{ color: '#a8a29e' }} onMouseOver={e => e.currentTarget.style.color = '#fff'} onMouseOut={e => e.currentTarget.style.color = '#a8a29e'}>New Arrivals</a></li>
                <li><a href="#/shop?collection=best_sellers" style={{ color: '#a8a29e' }} onMouseOver={e => e.currentTarget.style.color = '#fff'} onMouseOut={e => e.currentTarget.style.color = '#a8a29e'}>Best Sellers</a></li>
                <li><a href="#/shop?collection=premium" style={{ color: '#a8a29e' }} onMouseOver={e => e.currentTarget.style.color = '#fff'} onMouseOut={e => e.currentTarget.style.color = '#a8a29e'}>Premium Collection</a></li>
                <li><a href="#/shop?collection=sale" style={{ color: '#a8a29e' }} onMouseOver={e => e.currentTarget.style.color = '#fff'} onMouseOut={e => e.currentTarget.style.color = '#a8a29e'}>Special Offers & Sales</a></li>
              </ul>
            </div>
            ...
            <div>
              ...
              <ul style={{ listStyle: 'none', display: 'flex', flexDirection: 'column', gap: '0.6rem', fontSize: '0.85rem' }}>
                <li><a href="#/shop?occasion=Wedding" style={{ color: '#a8a29e' }} onMouseOver={e => e.currentTarget.style.color = '#fff'} onMouseOut={e => e.currentTarget.style.color = '#a8a29e'}>Bridal & Wedding</a></li>
                <li><a href="#/shop?occasion=Engagement" style={{ color: '#a8a29e' }} onMouseOver={e => e.currentTarget.style.color = '#fff'} onMouseOut={e => e.currentTarget.style.color = '#a8a29e'}>Engagement Rings</a></li>
                <li><a href="#/shop?occasion=Birthday" style={{ color: '#a8a29e' }} onMouseOver={e => e.currentTarget.style.color = '#fff'} onMouseOut={e => e.currentTarget.style.color = '#a8a29e'}>Birthday Gifts</a></li>
                <li><a href="#/shop?occasion=Gift" style={{ color: '#a8a29e' }} onMouseOver={e => e.currentTarget.style.color = '#fff'} onMouseOut={e => e.currentTarget.style.color = '#a8a29e'}>Gift Vouchers</a></li>
              </ul>
            </div>
          ...
          <div style={{ borderTop: '1px solid #272522', padding: '1.5rem 2rem', background: '#12100f' }}>
            <div style={{ maxWidth: '1200px', margin: '0 auto', display: 'flex', justifyContent: 'space-between', alignItems: 'center', flexWrap: 'wrap', gap: '1.5rem', fontSize: '0.8rem' }}>
              ...
              <div style={{ display: 'flex', gap: '1rem', alignItems: 'center', flexWrap: 'wrap' }}>
                ...
                <div style={{ display: 'flex', gap: '0.8rem', alignItems: 'center', borderLeft: '1px solid #272522', paddingLeft: '1rem' }}>
                  <a 
                    ...
                    style={{ color: '#78716c', display: 'flex', alignItems: 'center' }} 
              ...
              <div style={{ display: 'flex', gap: '1rem' }}>
                <a href="https://instagram.com" style={{ color: '#78716c', display: 'flex', alignItems: 'center' }} onMouseOver={e => e.currentTarget.style.color = 'var(--color-gold-primary)'} onMouseOut={e => e.currentTarget.style.color = '#78716c'} title="Instagram">
                  <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><rect width="20" height="20" x="2" y="2" rx="5" ry="5"/><path d="M16 11.37A4 4 0 1 1 12.63 8 4 4 0 0 1 16 11.37z"/><line x1="17.5" x2="17.51" y1="6.5" y2="6.5"/></svg>
                </a>
                <a href="https://facebook.com" style={{ color: '#78716c', display: 'flex', alignItems: 'center' }} onMouseOver={e => e.currentTarget.style.color = 'var(--color-gold-primary)'} onMouseOut={e => e.currentTarget.style.color = '#78716c'} title="Facebook">
...
function AdminLoginOnboarding({ onLoginSuccess }) {
  ...
  return (
    <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', minHeight: '75vh', background: 'transparent', padding: '3rem 2rem' }}>
      <form onSubmit={handleSubmit} style={{ width: '100%', maxWidth: '380px', background: 'rgba(255, 255, 255, 0.03)', border: '1px solid rgba(255, 255, 255, 0.12)', backdropFilter: 'blur(10px)', color: 'white', borderRadius: '8px', padding: '2.5rem', boxShadow: '0 15px 45px rgba(0,0,0,0.3)' }}>
        <div style={{ textAlign: 'center', marginBottom: '2rem' }}>
          <div style={{ width: '48px', height: '48px', borderRadius: '50%', background: 'rgba(194, 139, 83, 0.2)', display: 'flex', alignItems: 'center', justify: 'center', margin: '0 auto 1rem auto', color: 'var(--color-gold-light)' }}>
          ...
          <h2 style={{ fontSize: '1.4rem', color: '#ffffff' }}>Admin Dashboard</h2>
          <p style={{ fontSize: '0.8rem', color: 'rgba(255, 255, 255, 0.7)', marginTop: '0.25rem' }}>Restricted access. Please authenticate.</p>
        </div>

        {error && (
          <div style={{ background: 'rgba(220, 38, 38, 0.25)', color: '#f87171', border: '1px solid rgba(220, 38, 38, 0.4)', padding: '0.65rem 0.8rem', borderRadius: '4px', fontSize: '0.78rem', marginBottom: '1.2rem', fontWeight: 600 }}>
            ⚠️ {error}
          </div>
        )}

        <div className="form-group">
          <label className="form-label" style={{ fontSize: '0.72rem', color: '#ffffff' }}>Username</label>
          <input 
            type="text" 
            value={username}
        ...
        <div className="form-group" style={{ marginBottom: '1.5rem' }}>
          <label className="form-label" style={{ fontSize: '0.72rem', color: '#ffffff' }}>Password</label>
          <input 
            type="password" 
            value={password}
        ...
        <div style={{ marginTop: '1.5rem', padding: '0.75rem', background: 'rgba(255, 255, 255, 0.05)', borderRadius: '4px', fontSize: '0.72rem', color: 'rgba(255, 255, 255, 0.8)', textAlign: 'center', border: '1px solid rgba(255, 255, 255, 0.08)' }}>
          <strong>Default Login Tip:</strong> <br />
          User: <code style={{ background: 'rgba(255, 255, 255, 0.12)', color: '#ffffff', padding: '1px 3px', borderRadius: '2px' }}>admin</code> | Pass: <code style={{ background: 'rgba(255, 255, 255, 0.12)', color: '#ffffff', padding: '1px 3px', borderRadius: '2px' }}>admin123</code>
        </div>
      </form>
    </div>
  );
